...
class SunAndMoon_State extends State<SunAndMoon> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    super.initState();
    SunAndMoonCubit.get(context).initializeAnimation(
              ...
              child: Stack(children: [
                ...
                Positioned(
                  top: cubit.changBool
                      ? 0
                      : drawCurve_State()
                          .calculate(cubit.scaleAnimationX.value, cubit.path)
                          .dy,
                  left: drawCurve_State()
                      .calculate(cubit.scaleAnimationX.value, cubit.path)
                      .dx,
                  child: changState
                      ? const Image(
                          image: AssetImage('images/kindpng_51340.png'),
                          height: 50,
                          width: 50,
                        )
                      : const Image(
